...
export class DeepSeekProvider extends TranslationProvider {
  ...
  async translate({ text, sourceLang, targetLang }) {
    if (!this.apiKey) {
      throw new Error('API key not configured. Please set your DeepSeek API key in the extension settings.');
    }
...
- Maintain the tone and style of the original text`;
  ...
  /**
   * Call the DeepSeek chat completions API (OpenAI-compatible format).
   */
