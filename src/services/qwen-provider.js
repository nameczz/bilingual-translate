/**
 * Qwen (通义千问) translation provider.
 * Uses Alibaba DashScope OpenAI-compatible chat completions API.
 */
...
export class QwenProvider extends TranslationProvider {
  constructor() {
    super('Qwen');
    this.apiKey = null;
  }
  ...
  async translate({ text, sourceLang, targetLang }) {
    if (!this.apiKey) {
      throw new Error('API key not configured. Please set your Qwen API key in the extension settings.');
    }
...
- Maintain the tone and style of the original text`;
  ...
  /**
   * Call the Qwen chat completions API (OpenAI-compatible format).
   */
